...
from llmbot import load_plugins
from llmbot.sdk.func_calling import load_from_entrypoint, get_entrypoint_plugins
...
# 初始化插件系统
load_plugins("llmbot/extra/plugins")
load_from_entrypoint("llmbot.extra.plugin")
