...
from llmbot.middleware.chain_box import Chain, AUTH_MANAGER
from llmbot.middleware.router import RouterManager, Router
from llmbot.middleware.user import SubManager
from llmbot.schema import RawMessage
from llmbot.sdk.func_calling.register import ToolRegister
from llmbot.sdk.memory.redis import RedisChatMessageHistory
from llmbot.sender.telegram.utils import parse_command, is_valid_url
from llmbot.setting.telegram import BotSetting
...
class TelegramBotRunner(object):
    ...
    async def telegram(self):
        ...
        async def listen_help_command(message: types.Message):
            from llmbot.sender.telegram.event import help_message
